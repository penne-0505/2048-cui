...
class TileAnimation:
    ...
    duration: float
    value: int
    start_value: Optional[int] = None  # For merge animations
...
class AnimationManager:
    ...
    def add_move_animation(self, tile_id: str, from_pos: Tuple[int, int], 
                          to_pos: Tuple[int, int], value: int) -> None:
    ...
    def add_merge_animation(self, tile_id: str, pos: Tuple[int, int], 
    ...
    def add_spawn_animation(self, tile_id: str, pos: Tuple[int, int], value: int) -> None:
    ...
    def get_tile_render_data(self, tile_id: str) -> Optional[Dict[str, Any]]:
    ...
    def _update_animations(self) -> None:
        ...
        for animation in self.active_animations:
            if animation.is_finished:
                ...
                self.tile_positions[animation.tile_id] = animation.get_current_position()
